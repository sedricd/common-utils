...
public class ExcelUtils {
	...
	public static void generateExcel(String[] titles, List<String[]> rowData, String sheetName, int[] autoSizeColumn,
	...
	public static String getXSSFCellValue(XSSFRow row, int column) throws Exception {
			...
			switch (cell.getCellType()) {
				...
				case XSSFCell.CELL_TYPE_FORMULA:
					...
					if (HSSFDateUtil.isCellDateFormatted(cell)) {
						return DateUtils.date2Str(cell.getDateCellValue(), DateUtils.NORMAL_DATE_FORMAT);
					} else {
						cellvalue = getNumericCellStringValue(cell.getNumericCellValue());
					}
					break;
	...
	public static String getHSSFCellValue(HSSFRow row, int column) throws Exception {
		String cellvalue = StringUtils.EMPTY;
	...
	public static HSSFCellStyle getDefaultHSSFCellStyle(HSSFWorkbook workbook, HSSFFont font) {
		// 设置内容单元格格式
	...
	private static HSSFCellStyle getDefaultHSSFTitleStyle(HSSFWorkbook workbook, HSSFFont font) {
		// 设置title单元格格式
	...
	private static void output(HSSFWorkbook workbook, String fileName, HttpServletResponse response) {
